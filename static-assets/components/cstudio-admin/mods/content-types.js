      ...
      renderContentTypeTools: function (config) {
        ...
        toolbarEl.innerHTML = `
          ...
          <div class="content-type-tools-panel">
            ...
            <div>
              <input id="controlsSearchInput" class="content-types--controls--search-input" type="text" value="" placeholder="Inhaltselement suchen...">
          ...
          <div class="content-type-tools-panel">
            ...
            <div>
              <input id="datasourcesSearchInput" class="content-types--controls--search-input" type="text" value="" placeholder="Datenquelle suchen...">
